...
it('Component Filter - render 1 item correctly', () => {
  ...
  const wrapper = shallow(<Filter list={mock1} showMoviesByFilter={()=>{}} />);
...
it('Component Filter - render 2 items correctly', () => {
  ...
  const wrapper = shallow(<Filter list={mock2} showMoviesByFilter={()=>{}}/>);
...
it('Component Filter - render all items correctly', () => {
  ...
  const wrapper = shallow(<Filter list={mock3} showMoviesByFilter={()=>{}}/>);
